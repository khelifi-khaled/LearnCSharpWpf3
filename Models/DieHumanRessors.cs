...
{
    public class DirHumanRessors : User
    {

        public DirHumanRessors() { }

        public DirHumanRessors(DateTime birthday, string lastName = "LastName", string firstName = "FirstName", int idUser = 0, int levelAccess = 1, string password = "Password01", string picture = "", bool gender = true)
